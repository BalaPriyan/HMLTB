...
info("TIMEZONE synced with logging status")
...
MIRROR_REMOVE_UNWANTED = environ.get('MIRROR_REMOVE_UNWANTED', '')
if len(MIRROR_REMOVE_UNWANTED) == 0:
    MIRROR_REMOVE_UNWANTED = ''
...
config_dict = {
    ...
    'LEECH_REMOVE_UNWANTED': LEECH_FILENAME_REMNAME,
    'MIRROR_FILENAME_PREFIX': MIRROR_FILENAME_PREFIX,
    'MIRROR_FILENAME_SUFFIX': MIRROR_FILENAME_SUFFIX,
    'MIRROR_REMOVE_UNWANTED': MIRROR_FILENAME_REMNAME,
