...
async def fstats(_, query):
    ...
    stat = f'_____ Bot Info_____\n\n'\
           f'\n├<b>Active<b>: {acti}, Free: {free}, Queued: {inqu}\n\n' \
           f'\n├<b>Download<b>: {dwld}, Upload: {upld}, Seed: {seed}\n\n' \
           f'\n├<b>Split<b>: {splt}, Clone: {clon}\n\n' \
           f'\n├<b>Zip<b>: {arch}, UnZip: {extr}\n\n' \
           f'\n├<b>Free Disk<b>: {fdisk} ' \
           f'\n├<b>Uptime<b>: {get_readable_time(uptm)}'
