...
class WZMLStyle:
    ...
    ST_BN1_NAME = 'Main Channel'
    ST_BN1_URL = 'https://t.me/TomenMain'
    ST_BN2_NAME = 'Support'
    ST_BN2_URL = 'https://t.me/+1DI3E_tGRvsxMjJl'
    ST_MSG = '''<i>This bot can mirror all your links|files|torrents to Google Drive or any rclone cloud or to telegram</i>
<b>Type {help_command} to get a list of available commands</b>'''
    ST_BOTPM = '''<i>Now, This bot will send all your files and links here. Start Using ...</i>'''
    ST_UNAUTH = '''<i>You Are not authorized user Join Support And ASk ADmin To Access Mirror-Leech bot</i>'''
    # ---------------------
